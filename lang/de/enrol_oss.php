...
$string['class_settings_desc'] = '<p>Diese Einstellungen betreffen einen Kursbereich für Klassen. Genaueres finden Sie im <a href="TUTORIAL-de.md#Einstellungen für Klassen">Tutorial</a>.</p>';
...
$string['parents_settings_desc'] = '<p>Einstellungen für Eltern (siehe auch im <a href=""TUTORIAL-de.md#Einstellungen für Eltern">Tutorial</a>).</p>';
...
$string['parents_childfield'] = 'Kind ID Feld';
$string['parents_childfield_desc'] = 'Das Feld aus dem die Kind ID bezogen wird.';
...
$string['pluginname_desc'] = '<p>Ein OSS-Server oder ein anderer LDAP-Server kann als Quelle automatischer Einschreibung verwendet werden (siehe <a href="TUTORIAL-de.md#OSS Einschreibung">Tutorial OSS-Einschreibung</a>).</p>';
