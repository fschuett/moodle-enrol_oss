...
$string['parents_settings_desc'] = '<p>Diese Einstellungen stellen eine Verwaltung von Eltern-/Kind-Beziehungen über die Seite <b>Elternverwaltung</b> im Bereich "Nutzerpflege" bereit. Es werden für Schülerkonten des LDAP-Servers automatisch Elternkonten angelegt bzw. auch wieder entfernt. Alternativ können diese Konten auch im Bereich Nutzerverwaltung importiert werden (siehe dazu die Datei README.md).</p><p>Dort ist auch angegeben, wie die Namen der Elternkonten aussehen müssen (u.a. müssen sie mit dem <b>Eltern-Präfix</b> beginnen und mit einem Text enden, der das zugehörige Kind eindeutig identifiziert).</p>';
