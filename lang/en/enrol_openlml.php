...
$string['pluginname_desc'] = '<p>This plugin is supposed to be used with german <strong>Open LML</strong> school server and ist tailored to it\'s LDAP structure.</p><p>This plugin enrols users into courses based on the course <strong>idnumber</strong></p>';
$string['pluginname'] = 'Open LML Enrolment';
$string['pluginnotenabled'] = 'Plugin not enabled!';
$string['prefix_teacher_members'] = 'In courses with this prefix teachers can be enrolled as members';
...
$string['teachers_course_id'] = 'teachers group name in moodle, usually teachers';
$string['teachers_course_id_key'] = 'teachers group name';
