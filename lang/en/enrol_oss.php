...
$string['class_settings_desc'] = '<p>These settings provide a class category, where classes with specified prefixes are created as moodle courses and teachers, students are enroled with different roles.</p><p>Classes can be identified either by class attribute and corresponding value or name prefixes can be used, in which case attribute and attribute value are not used.</p><p>The category can be autocreated and also the classes. Classes can be autoremoved. All this is done in a scheduled task named <b>oss_sync_classes_task</b></p>';
