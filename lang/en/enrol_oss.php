...
$string['groups_enabled_desc'] = 'create and maintain teachers, students groups in each class for easier mail communication';
$string['groups_teachers_group'] = 'teachers';
$string['groups_students_group'] = 'students';
