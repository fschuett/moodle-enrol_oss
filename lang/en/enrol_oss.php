...
$string['class_settings_desc'] = '<p>For a detailed description see the <a href="TUTORIAL-en.md#Class settings">Tutorial</a>.</p>';
...
$string['parents_settings_desc'] = '<p>These are the parent - child relationship settings (for more details see the <a href="TUTORIAL-en.md#Parents settings">Tutorial</a></p>';
...
$string['parents_childfield'] = 'Child ID field';
$string['parents_childfield_desc'] = 'Field the child ID is taken from';
...
$string['pluginname_desc'] = '<p>See <a href="TUTORIAL-en.md#Description">Tutorial</a> for a detailed description.</p>';
