...
/**
 * Check if parents setup is parents_enabled
 *
 * @return bool true|false
 */
function parents_enabled() {
	global $CFG;
	
	if(!enrol_is_enabled('oss')) {
		return false;
	} else {
		$enabled = get_config('enrol_oss', 'parents_enabled');
		if( $enabled == 0 ) {
			return false;
		} else {
			return true;
...
/**
 * Get all parents records
 *
 * @return array parents records
 */
function enrol_oss_parents_list() {
    global $DB;
...
/**
 * Get all orphaned parents records
 *
 * @return array parents records
 */
function enrol_oss_orphaned_parents_list() {
    global $DB;
...
/**
 * Get all orphaned students records
 *
 * @return array orphaned students records
 */
function enrol_oss_orphaned_students_list() {
    global $DB;
